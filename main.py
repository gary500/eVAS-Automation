...
df = pd.read_excel('C:/Users/lambsarg/Desktop/addOrderData.xlsx', sheet_name='Sheet1')

messages = []

for i in range(1, len(df.columns)+1):

    url="http://localhost:8080/eVASWS.ORDER/services/OrderPort"
    headers = {'content-type': 'text/xml'}
    body = """<soapenv:Envelope xmlns:soapenv='http://schemas.xmlsoap.org/soap/envelope/' xmlns:v1='http://www.GGS.com/eVASServices/v1.0/'>
       <soapenv:Header>
          <v1:EVASSOAPHeader>
